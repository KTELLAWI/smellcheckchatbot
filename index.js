...
const client = new Client({
    ...
    puppeteer: {
        headless: true, // Puppeteer will run in the background
...
// Function to load characteristics from the files
...
client.on('ready', () => {
    ...
    //    <center>
    //       <h2  class="w3-jumbo w3-animate-top">ChatBot is ready you can use it Now!!</h2>
